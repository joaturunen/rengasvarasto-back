...
insert into ordertable (id, services_id) values
(0, 4), (1, 2), (2, 0), (3, 1), (4, 3);

insert into car (id, register, brand, model, tiresize, tirebolt) values
...
insert into tires (id, customer_id, car_id, slot_id, employee_id, brand, model, type, dustrims, groovefl, groovefr, groovebl, groovebr, text, rims, servicedate, info) values
...
(4, 4, 4, 11, 3, 'Purukumit', '195/32R14', 'kitka', 'ei', 1, 1, 1, 1, 'Renkaat on mukavan sileät, poliisi-setä tykkää', 'ei', '17-11-2120 16:55:10', 'Asiakkaan kannattaisi ostaa uudet renkaat');